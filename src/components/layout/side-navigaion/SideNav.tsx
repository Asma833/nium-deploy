            ...
            <li key={idx} className="list-none">
              {item.dropdown ? (
                <>
                  ...
                  <div
                    className={cn(
                      'flex items-center justify-between w-full pl-5 px-2 py-3 my-2 rounded-md cursor-pointer transition-colors',
                      ...
                      {item.dropdown.map((subItem, subIdx) => (
                        <li key={subIdx} className="list-none">
                          <NavLink
                            ...
                            className={({ isActive }) =>
                              cn(
                                'block pl-5 py-2 px-2 text-sm rounded-md hover:bg-muted/20 cursor-pointer',
